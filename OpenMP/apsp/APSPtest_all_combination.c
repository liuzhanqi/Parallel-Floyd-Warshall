...
// int i0, i1, i2, sum, i, j, k;
// #pragma omp threadprivate(i0, i1, i2, sum, i, j, k)
...
// void PL_APSP_X(int* mat, int N, int num_thread) {
// 	int i0, i1, i2, sum, i, j, k = 0;
// 	#pragma omp parallel shared(k) private(i0, i1, i2, sum, i, j)
// 	{
// 		while (k < N) {
// 			#pragma omp for
// 			for (i = 0; i < N; ++i) {
...
// void PL_APSP_X(int* mat, int N, int num_thread) {
// 	int i0, i1, i2, sum, i, j, k;
// 	#pragma omp parallel private(i0, i1, i2, sum, i, j, k)
// 	{
// 		for (k = 0; k < N; k++) {
// 			#pragma omp for
// 			for (i = 0; i < N; ++i) {
